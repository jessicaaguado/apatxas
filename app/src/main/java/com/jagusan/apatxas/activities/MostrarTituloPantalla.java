...
public class MostrarTituloPantalla {
    ...
    public static final boolean DETALLE = true;
    public static final boolean LISTA_PERSONAS = true;
    public static final boolean EDITAR_APATXA = true;
    public static final boolean LISTA_GASTOS = true;
